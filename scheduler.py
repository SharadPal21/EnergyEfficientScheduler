...
def energy_efficient_rr(processes, time_quantum):
    power_map = {"Low": 1, "Medium": 2, "High": 3}  # Power mapping
...
# Sample Processes with Correct Power Levels
process_list = [
    Process("P1", 8, "Low"),   # 1 unit per cycle
    Process("P2", 4, "Medium"),# 2 units per cycle
    Process("P3", 6, "High"),  # 3 units per cycle
    Process("P4", 3, "Low")    # 1 unit per cycle
]
